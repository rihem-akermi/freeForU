...
| `AGENT`  | Gérer profil, offres, publications, horaires hebdo, blocages ponctuels, consulter/réagir aux réservations du jour, confirmer/annuler une demande de réservation (`agent-status`), confirmer sa part de fin de prestation |
